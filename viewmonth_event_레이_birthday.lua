...
function scene:create( event )
	if limit9992 == 1 then
		composer.removeScene("viewmonth_script_레이_birthday")
	...
	local function next1_1(event) --choose1 골랐을때 표정
		if event.phase == "began" then
			composer.setVariable("what", 5)
			composer.removeScene("viewmonth_event_레이_birthday")
