...
function scene:create( event )
	...
	local function closePop(event)
		composer.removeScene("view11Bag2")
	...
	--팝업창 띄우는 이벤트
	popup2 = display.newImage(itemPop(loadedItems.itemPop) , display.contentWidth/2, display.contentHeight/2)
	sceneGroup:insert(popup2)
	exit2 = display.newImage("image/공통-x버튼.png", display.contentWidth/2, 460)
