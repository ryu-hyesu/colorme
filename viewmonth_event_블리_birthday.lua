...
function scene:create( event )
	if limit9992 == 1 then
		composer.removeScene("viewmonth_script_블리_birthday")
	...
	local function next1_1(event) --choose1 골랐을때 표정
		if event.phase == "began" then
			composer.setVariable("what", 1)
			composer.removeScene("viewmonth_event_블리_birthday")
